...
function userRegisterValidation(){
    return [
        ...
        body("password", "Must have at least 1 lowercase 1 uppercase 1 symbol and  8 characters")
        .isStrongPassword(),
...
function userLoginValidation(){
  return [
        body("email", "Email is required").isEmail(),
        body("password", "Password must have 1 lowercase 1 uppercase 1 symbol and should be 8 characters")
        .isStrongPassword()
  ]
}
